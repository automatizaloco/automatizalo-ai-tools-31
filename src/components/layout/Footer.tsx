          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                <Phone size={20} className="mr-3 text-automatizalo-blue shrink-0" />
                <a href="tel:+1234567890" className="text-gray-600 hover:text-automatizalo-blue transition-colors">
                  +1 (234) 567-890
                </a>
              </li>
              <li className="flex items-center">
                <Mail size={20} className="mr-3 text-automatizalo-blue shrink-0" />
                <a href="mailto:info@automatizalo.com" className="text-gray-600 hover:text-automatizalo-blue transition-colors">
                  info@automatizalo.com
                </a>
              </li>
            </ul>
          </div>
