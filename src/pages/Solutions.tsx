        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            <h1 className="text-4xl md:text-5xl font-heading font-bold text-gray-900 mb-6">
              {isAuthenticated ? <EditableText id="solutions-title" defaultText={t("solutions.title")} /> : t("solutions.title")}
            </h1>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-10">
              {isAuthenticated ? <EditableText id="solutions-subtitle" defaultText={t("solutions.subtitle")} /> : t("solutions.subtitle")}
            </p>
          </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
              <div className="lg:w-1/2">
                <h2 className="text-3xl font-semibold text-gray-900 mb-6">
                  {isAuthenticated ? <EditableText id="solutions-chatbots-title" defaultText={t("solutions.chatbots.title")} /> : t("solutions.chatbots.title")}
                </h2>
                <p className="text-gray-600 mb-6">
                  {isAuthenticated ? <EditableText id="solutions-chatbots-description" defaultText={t("solutions.chatbots.description")} /> : t("solutions.chatbots.description")}
                </p>
          ...
          <div className="mb-24 scroll-mt-24" id="conversational-ai">
            <div className="flex flex-col lg:flex-row-reverse items-center gap-12 mb-16">
              <div className="lg:w-1/2">
                <h2 className="text-3xl font-semibold text-gray-900 mb-6">
                  {isAuthenticated ? <EditableText id="solutions-socialmedia-title" defaultText={t("solutions.socialMedia.title")} /> : t("solutions.socialMedia.title")}
                </h2>
                <p className="text-gray-600 mb-6">
                  {isAuthenticated ? <EditableText id="solutions-socialmedia-description" defaultText={t("solutions.socialMedia.description")} /> : t("solutions.socialMedia.description")}
                </p>
                <p className="text-gray-600">
                  {isAuthenticated ? <EditableText id="solutions-futureproof-subtitle" defaultText={t("solutions.futureproof.subtitle")} /> : t("solutions.futureproof.subtitle")}
                </p>
              </div>
              <div className="lg:w-1/2">
          ...
          <div className="mb-24 scroll-mt-24" id="data-intelligence">
            <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
              <div className="lg:w-1/2">
                <h2 className="text-3xl font-semibold text-gray-900 mb-6">
                  {isAuthenticated ? <EditableText id="solutions-aiagents-title" defaultText={t("solutions.aiAgents.title")} /> : t("solutions.aiAgents.title")}
                </h2>
                <p className="text-gray-600 mb-6">
                  {isAuthenticated ? <EditableText id="solutions-aiagents-description" defaultText={t("solutions.aiAgents.description")} /> : t("solutions.aiAgents.description")}
                </p>
                <p className="text-gray-600">
