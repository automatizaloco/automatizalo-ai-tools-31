      ...
      <section className="pt-28 pb-16 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            {isAuthenticated ? (
              <EditableText 
                id="solutions-hero-description"
                defaultText={t('solutions.description')}
              />
            ) : (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: <Zap size={24} />, text: t('solutions.futureproof.features.0') || 'Scalable Solutions' },
                { icon: <Brain size={24} />, text: t('solutions.futureproof.features.1') || 'Advanced AI' },
                { icon: <Shield size={24} />, text: t('solutions.futureproof.features.2') || 'Custom Integration' },
                { icon: <Clock size={24} />, text: t('solutions.futureproof.features.3') || '24/7 Support' }
              ].map((feature, index) => (
      ...
      <section className="py-16 bg-automatizalo-blue text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              variant="outline" 
              className="border-white text-white hover:bg-white hover:text-automatizalo-blue px-8 py-3 text-lg"
            >
